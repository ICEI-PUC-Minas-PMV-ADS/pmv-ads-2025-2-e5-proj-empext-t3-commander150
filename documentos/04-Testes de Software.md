...
| Torneio | Visualizar Histórico | CT-037-S | LOJA visualiza aba "Seus Torneios" com torneios abertos | LOJA logada, com torneios no status "Aberto" | Sucesso | Exibe lista de torneios abertos da loja com status "Aberto" |
| Torneio | Visualizar Histórico | CT-037-I | LOJA visualiza aba "Seus Torneios" sem torneios abertos | LOJA logada, sem torneios no status "Aberto" | Insucesso | Exibe mensagem "Você ainda não tem torneios abertos." |
| Torneio | Visualizar Histórico | CT-038-S | LOJA visualiza aba "Em Andamento" com torneios | LOJA logada, com torneios no status "Em Andamento" | Sucesso | Exibe lista de torneios em andamento da loja |
| Torneio | Visualizar Histórico | CT-038-I | LOJA visualiza aba "Em Andamento" sem torneios | LOJA logada, sem torneios no status "Em Andamento" | Insucesso | Exibe mensagem "Nenhum torneio em andamento." |
| Torneio | Visualizar Histórico | CT-039-S | LOJA visualiza aba "Histórico" com torneios | LOJA logada, com torneios no status "Finalizado" | Sucesso | Exibe lista de torneios finalizados da loja |
| Torneio | Visualizar Histórico | CT-039-I | LOJA visualiza aba "Histórico" sem torneios | LOJA logada, sem torneios no status "Finalizado" | Insucesso | Exibe mensagem "Nenhum torneio finalizado no histórico." |
| Torneio | Visualizar Histórico | CT-040-S | JOGADOR visualiza aba "Torneios Inscritos" com torneios | JOGADOR logado, inscrito em torneios abertos | Sucesso | Exibe lista de torneios inscritos com status "Inscrito" |
| Torneio | Visualizar Histórico | CT-040-I | JOGADOR visualiza aba "Torneios Inscritos" sem torneios | JOGADOR logado, não inscrito em torneios | Insucesso | Exibe mensagem "Você não está inscrito em nenhum torneio no momento." |
| Torneio | Visualizar Histórico | CT-041-S | JOGADOR visualiza aba "Em Andamento" com torneios | JOGADOR logado, com torneios inscritos em andamento | Sucesso | Exibe lista de torneios em andamento do jogador |
| Torneio | Visualizar Histórico | CT-041-I | JOGADOR visualiza aba "Em Andamento" sem torneios | JOGADOR logado, sem torneios em andamento | Insucesso | Exibe mensagem "Nenhum torneio em andamento." |
| Torneio | Visualizar Histórico | CT-042-S | JOGADOR visualiza aba "Histórico" com torneios | JOGADOR logado, com torneios finalizados | Sucesso | Exibe lista de torneios finalizados do jogador |
| Torneio | Visualizar Histórico | CT-042-I | JOGADOR visualiza aba "Histórico" sem torneios | JOGADOR logado, sem torneios finalizados | Insucesso | Exibe mensagem "Nenhum torneio no histórico." |
| Torneio | Desinscrever-se de Torneio| CT-043-S | JOGADOR desinscreve-se de torneio com sucesso | JOGADOR logado, na aba "Torneios Inscritos", clica "Desinscrever-se" | Sucesso | Remove torneio da lista |
| Torneio | Desinscrever-se de Torneio| CT-043-I | JOGADOR falha ao desinscrever-se | JOGADOR logado, tenta desinscrever com erro de API | Insucesso | Exibe mensagem "Não foi possível desinscrever-se do torneio." |
| Permissão | Controlar Acesso no Histórico | CT-044-S | LOJA não vê botão desinscrever | LOJA logada em qualquer aba | Sucesso | Botão "Desinscrever-se" não é renderizado |
| Permissão | Controlar Acesso no Histórico | CT-044-I | JOGADOR não vê botão desinscrever em torneio inscrito aberto | JOGADOR logado na aba "Torneios Inscritos"  | Insucesso | Botão "Desinscrever-se" não é renderizado |
| Permissão | Controlar Acesso no Histórico | CT-045-S | LOJA vê labels corretos nas abas | LOJA logada acessa histórico | Sucesso | Labels: "Seus Torneios", "Em Andamento", "Histórico" |
| Permissão | Controlar Acesso no Histórico | CT-045-I | JOGADOR vê labels corretos nas abas | JOGADOR logado acessa histórico | Sucesso | Labels: "Torneios Inscritos", "Em Andamento", "Histórico de Torneios" |
| Torneio | Carregar Dados, Histórico | CT-046-S | Carregamento bem-sucedido, LOJA | LOJA logada com torneios existentes | Sucesso | Exibe lista de torneios organizada por status |
| Torneio | Carregar Dados, Histórico | CT-046-I | Carregamento falha, LOJA | LOJA logada com erro de API | Insucesso | Exibe mensagem "Não foi possível carregar seus torneios." |
| Torneio | Carregar Dados, Histórico | CT-047-S | Carregamento bem-sucedido, JOGADOR | JOGADOR logado com torneios existentes | Sucesso | Exibe lista de torneios organizada por status |
